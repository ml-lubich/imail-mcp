...
def guide_text() -> str:
    ...
    lines = [
        ...
        "  4. Maximally Lowercase Subjects: Use lowercase subjects for outreach/replies (-H / --humanize).",
        "  5. Quotes Over Backticks: Use quotes \"filename.pdf\" instead of code backticks `filename.pdf` when referencing files/terms.",
        "  6. No Random Bolding: Avoid random bolding (**text**) inside email bodies. Keep text clean and unbolded.",
        "  7. Prefer PDF Attachments: Attach .pdf documents (resumes, JDs, portfolios) rather than raw .md files.",
        "  8. Uniform Typography: Use -m / --markdown for 100% uniform Gmail Sans Serif (Arial/Helvetica, 14px, #222222) across headings, body, and lists with zero font mixing.",
        "  9. Humanizer (-H / --humanize): Use -H / --humanize for subtle natural human casing/punctuation touch (inspired by blader/humanizer).",
        " 10. Draft Review: Use -o / --open to launch a native WebKit draft in Mail.app for user review.",
        "",
        "Agent introspection:",
