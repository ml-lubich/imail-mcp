...
def guide_text() -> str:
    ...
    lines = [
        ...
        "  2. Short & Brief: Keep emails brief, polite, and to the point. Avoid artificial optimism or corporate hyperbole.",
        "  3. Max 1-2 Exclamation Marks: Limit exclamation marks to max 1-2 per email. Never use consecutive !! or !!!.",
        "  4. Natural Sign-offs: NO 'Best regards' or 'Best'. Use 'Thanks,', 'Thank you!', 'Looking forward to our call!', or 'Sincerely,'.",
        "  5. No Subject Duplication: NEVER put '# Subject' or main title headings inside the email body.",
        "  6. Zero Emojis: NO emojis in subjects or bodies for replies or outreach.",
        "  7. Maximally Lowercase Subjects: Use lowercase subjects for outreach/replies (-H / --humanize).",
        "  8. Quotes Over Backticks: Use quotes \"filename.pdf\" instead of code backticks `filename.pdf` when referencing files/terms.",
        "  9. No Random Bolding: Avoid random bolding (**text**) inside email bodies. Keep text clean and unbolded.",
        " 10. Prefer PDF Attachments: Attach .pdf documents (resumes, JDs, portfolios) rather than raw .md files.",
        " 11. Uniform Typography: Use -m / --markdown for 100% uniform Gmail Sans Serif (Arial/Helvetica, 14px, #222222) across headings, body, and lists with zero font mixing.",
        " 12. Humanizer (-H / --humanize): Use -H / --humanize for subtle natural human casing/punctuation touch (inspired by blader/humanizer).",
        " 13. Draft Review: Use -o / --open to launch a native WebKit draft in Mail.app for user review.",
        "",
        "Agent introspection:",
