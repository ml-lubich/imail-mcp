...
def guide_text() -> str:
    ...
    lines = [
        ...
        "",
        "Agent Instructions & Human Email Writing Rules:",
        "  1. Wall Check: Verify sender account matches work vs personal wall rules.",
        "  2. Human Tone & Style: Write concise, polite, natural human body text. Avoid robotic placeholders or AI clichés.",
        "  3. Uniform Typography: Use -m / --markdown for 100% uniform Gmail Sans Serif (Arial/Helvetica, 14px, #222222) across headings, body, and lists with zero font mixing.",
        "  4. Attachments & Bundling: Pass -a / --attach for files (e.g. resumes, PDFs). Use --zip to bundle multiple attachments.",
        "  5. Draft Review: Use -o / --open to launch a native WebKit draft in Mail.app for user review.",
        "",
        "Agent introspection:",
